	...
	function (i, items) {
		return _elm_lang$core$List$head(
			A2(
				_elm_lang$core$List$map,
				function (n) {
					return _elm_lang$core$Tuple$second(n);
				},
				A2(
...
var _user$project$Latte_Common_Helper$calcFirstDsPercents = function (model) {
	...
	var dsSum = _elm_lang$core$List$sum(dataset.values);
	return A2(
		_elm_lang$core$List$map,
		function (n) {
			return (n * 100) / dsSum;
...
var _user$project$Latte_Common_Style$svgFontStyle = A2(
	_elm_lang$core$Basics_ops['++'],
	{
		...
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'color', _1: 'rgb(108, 118, 128)'},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'display', _1: 'inline'},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'fill', _1: 'rgb(85, 91, 81)'},
					_1: {ctor: '[]'}
				}
			}
		}
					...
					_1: {
						...
						_1: {
							...
							_0: _elm_lang$html$Html_Attributes$style(
								{
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'stroke', _1: strokeColor},
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'stroke-width', _1: '1'},
										_1: {
											ctor: '::',
			...
			_elm_lang$svg$Svg$g,
			{
				...
				_0: _elm_lang$svg$Svg_Attributes$transform(
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							_elm_lang$core$Basics$toString(pos + 18),
							')'))),
				_1: {ctor: '[]'}
			},
			{
					...
					return A2(
						...
						_elm_lang$core$Basics$toFloat(
							_elm_lang$core$Basics$round(
								yStep * _elm_lang$core$Basics$toFloat(n))));
				},
				A2(
					_elm_lang$core$List$range,
					0,
...
var _user$project$Latte_Common_Ticks$barTickAnimate = function (height) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$attributeName('height'),
			_1: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$from('0'),
				_1: {
					ctor: '::',
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$dur('0.4s'),
						_1: {
							ctor: '::',
		...
		return A2(
			_elm_lang$svg$Svg$circle,
			{
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$cx('17'),
							_1: {
								ctor: '::',
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$attributeName('cy'),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$from('0'),
							_1: {
			...
			_elm_lang$svg$Svg$line,
			{
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$y2(ly2),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$style(
									{
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'stroke', _1: '#999'},
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'stroke-width', _1: '0.7'},
											_1: {ctor: '[]'}
										}
									}),
								_1: {ctor: '[]'}
...
var _user$project$Latte_Common_Ticks$textTickItem = function (label) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$x('17.5'),
			_1: {
				ctor: '::',
...
var _user$project$Latte_Common_Title$titleStyle = _elm_lang$html$Html_Attributes$style(
	{
		...
		_1: {
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'font-family', _1: '\"proxima-nova\", sans-serif'},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'color', _1: '#6c7680'},
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$Latte_Common_Title$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(model.userData.title),
			_1: {ctor: '[]'}
		});
};
				...
				_user$project$Latte_Common_Style$fontStyle,
				{
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'display', _1: state.tooltip.display},
								_1: {
									ctor: '::',
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(model.state.tooltip.label),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html$text(
										A2(
											_elm_lang$core$Basics_ops['++'],
											' ',
											A2(_elm_lang$core$Basics_ops['++'], model.state.tooltip.title, '%'))),
									_1: {ctor: '[]'}
								}
							}),
						_1: {ctor: '[]'}
		...
		var attrs = _elm_lang$html$Html_Attributes$style(
			{
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'background',
					_1: A2(_elm_lang$core$Basics_ops['++'], color, ' none repeat scroll 0% 0%')
				},
				_1: {
					ctor: '::',
					_0: {
		...
		return {
			...
			state: {
				...
				tooltip: {
					...
					ds: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'Value', _1: 'Title'},
						_1: {ctor: '[]'}
					}
				},
				barChart: {selected: -1},
...
var _user$project$Landing$mainChart = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
...
var _user$project$Landing$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
									...
									_0: A2(
										...
										},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$class('logo animated bounceInDown'),
													_1: {ctor: '[]'}
												},
												{ctor: '[]'}),
											_1: {
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$class('subtitle animated fadeIn'),
														_1: {ctor: '[]'}
													},
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('Library for creating charts in Elm language'),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}
												...
												},
												{
													...
													_0: A2(
														_elm_lang$html$Html$img,
														{
															...
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$src('./www/images/GitHub_Logo.png'),
																_1: {ctor: '[]'}
															}
														},
														{ctor: '[]'}),
													...
													},
													{
														...
														_0: A2(
															_elm_lang$html$Html$img,
															{
																...
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$src('./www/images/elm.svg'),
																	_1: {ctor: '[]'}
																}
															},
															{ctor: '[]'}),
...
var _user$project$Landing$main = _elm_lang$html$Html$program(
	{init: _user$project$Landing$init, view: _user$project$Landing$view, update: _user$project$Landing$update, subscriptions: _user$project$Landing$subscriptions})();
var _user$project$Landing$jupiterView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
					...
					_1: {
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Compare the biggest on latte bar chart!'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
...
var Elm = {};
Elm['Landing'] = Elm['Landing'] || {};
if (typeof _user$project$Landing$main !== 'undefined') {
    _user$project$Landing$main(Elm['Landing'], 'Landing', undefined);
}
