...
var _user$project$BarChart$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'Latte') {
			return {
...
var _user$project$BarChart$init = function () {
	var model = {
...
var _user$project$BarChart$Model = F2(
	function (a, b) {
		return {hello: a, latte: b};
	});
var _user$project$BarChart$Resize = F2(
	function (a, b) {
		return {ctor: 'Resize', _0: a, _1: b};
	});
var _user$project$BarChart$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			...
			_0: _elm_lang$window$Window$resizes(
				function (_p1) {
					var _p2 = _p1;
					return A2(_user$project$BarChart$Resize, _p2.height, _p2.width);
				}),
			_1: {ctor: '[]'}
		});
};
var _user$project$BarChart$Latte = function (a) {
	return {ctor: 'Latte', _0: a};
};
var _user$project$BarChart$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				_user$project$BarChart$Latte,
				_user$project$Latte$latteDraw(model.latte)),
			_1: {ctor: '[]'}
		});
};
var _user$project$BarChart$main = _elm_lang$html$Html$program(
	{init: _user$project$BarChart$init, view: _user$project$BarChart$view, update: _user$project$BarChart$update, subscriptions: _user$project$BarChart$subscriptions})();

var Elm = {};
Elm['BarChart'] = Elm['BarChart'] || {};
if (typeof _user$project$BarChart$main !== 'undefined') {
    _user$project$BarChart$main(Elm['BarChart'], 'BarChart', undefined);
}
